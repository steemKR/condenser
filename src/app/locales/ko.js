...
const ko = 	{
	...
	about: "스팀이란 무엇인가요",
	APP_NAME_whitepaper: "Steem" + " 백서",
	explore: "토픽 둘러보기",
	buy_LIQUID_TOKEN: LIQUID_TOKEN + " 매수",
	sell_LIQUID_TOKEN: LIQUID_TOKEN + " 매도",
	market: "거래소",
	currency_market: "내부 거래소",
	stolen_account_recovery: "도난당한 계정 찾기",
	change_account_password: "비밀번호 변경하기",
	steemit_api_docs: "Steemit API 문서",
	APP_NAME_chat: "Steemit 채팅",
	witnesses: "증인들",
	...
	buy: '구매',
	sell: '판매',
	buy_VESTING_TOKEN: VESTING_TOKEN + ' 구매하기',
	transaction_history: '트랜잭션 내역',
	submit_a_story: '글쓰기',
	nothing_yet: '아직 아무것도 없습니다',
	close: '닫기',
	// next 5 strings were supposed to be sinngle block of text, but due large size,
	// code erros they were splitted.
	authors_get_paid_when_people_like_you_upvote_their_post: '사람들이 글에 투표를 하면 해당 작성자들은 그에 따른 보상을 받게 됩니다.',
	if_you_enjoyed_what_you_read_earn_amount: '커뮤니티에 가입하여 댓글을 달고, 투표로 보상을 지급해보세요',
	when_you_link_text: '회원가입',
	read_only_mode: '서버 점검으로 인해 읽기만 가능합니다. 불편을 끼쳐 드려 죄송합니다.',
	...
	submit_email_to_get_on_waiting_list: '가입 대기 목록에 이메일을 제출합니다.',
	login: '로그인',
	logout: '로그아웃',
	show_less_low_value_posts: "Show fewer low value posts",
	show_more_low_value_posts: "Show more low value posts",
	select_topic: '토픽 선택',
	tags_and_topics: "태그 및 토픽",
	filter: "필터",
	show_more_topics: "더 많은 토픽 보기",
	...
	personal_info_will_be_private: '귀하의 개인정보가 유지됩니다.',
	personal_info_will_be_private_link: '개인',
	continue_with_facebook: 'Facebook으로 계속하기',
	continue_with_reddit: 'Reddit으로 계속하기',
	continue_with_vk: 'Vk로 계속하기',
	requires_positive_karma: '레딧 댓글 카르마가 필요합니다',
	dont_have_facebook: '페이스북이나 레딧 계정이 없으신가요?',
	subscribe_to_get_sms_confirm: 'SMS 확인이 가능할때 알림을 받기위해서 구독 하세요',
	by_verifying_you_agree: '이 계정을 인증함으로서' + APP_NAME + "에 동의하게 됩니다.",
	by_verifying_you_agree_terms_and_conditions: '이용 약관',
	...
	/* end dropdown menu */
	loading: '로딩중',
	cryptography_test_failed: '암호화 시도 실패',
	unable_to_log_you_in: '이 브라우저에서는 더이상 로그인이 불가능합니다.',
	...
	the_latest_versions_of: '최신 버전의',
	and: '그리고',
	or: '또는',
	are_well_tested_and_known_to_work_with: 'are well tested and known to work with ' + APP_DOMAIN + '.',
	account_creation_succes: '계정이 성공적으로 만들어졌습니다!',
	account_recovery_succes: '계정이 성공적으로 복구되었습니다!',
	password_update_succes: '{accountName} 계정의 패스워드가 성공적으로 업데이트 되었습니다',
	...
	login_form_information: 'SteemKR은 개발중인 서비스 입니다. 사고에 대해서 보상해드릴 수 없습니다. 포스팅키만 사용하시기를 권장드립니다.',
	...
	clear: '지우기',
	save: '저장',
	insert_image_by_drag_and_drop: '이미지를 넣으시려면 드래그앤 드롭',
	paste_from_clipboard: '클립보드를 붙여넣기',
	...
	preview: '미리보기',
	markdown_not_supported: '마크다운을 지원하지 않습니다',
	welcome_to_the_blockchain: '블록체인 세상에 온걸 환영합니다!',
	your_voice_is_worth_something: '당신의 의견은 분명 가치가 있습니다.',
	learn_more: '더 알아보기',
	get_sp_when_sign_up: '지금 가입하셔서 무료 ' + VESTING_TOKEN + '을 받으세요.',
	...
	tag_your_story: '태그 (최대 5개), 첫번째로 입력한 태그가 메인 태그로 지정됩니다.',
	select_a_tag: '태그를 입력해주세요',
	required: '필수',
	...
	use_limited_amount_of_tags: '{tagsLength}개의 태그를 입력하셨습니다. 전체 {includingCategory}.  글과 태그필드에 최대 5개의 태그만 입력해주세요.',
	// this is mainly used in CategorySelector
	maximum_tag_length_is_24_characters: '태그 길이는 최대 24글자 입니다',
	use_limitied_amount_of_categories: '{amount}개의 카테고리만 사용해주세요',
	use_only_lowercase_letters: '소문자로만 입력해주세요',
	use_one_dash: '대시(-)는 하나만 사용하실 수 있습니다',
	use_spaces_to_separate_tags: '공백으로 태그를 구분해주세요',
	use_only_allowed_characters: '소문자, 숫자, 하나의 대쉬만 사용해주세요.',
	must_start_with_a_letter: '첫글자는 문자로 입력해주세요',
	...
	// BlocktradesDeposit
	change_deposit_address: '입금 계좌 변경하기',
	get_deposit_address: '입금 계좌 생성하기',
	...
	transfer_amount_to: "보냄, {amount}을 다음에게:",
	recieve_amount_from: "받음, {amount}을 으로부터:",
	...
	higher: '높은', // context is about prices
	lower: '낮은', // context is about prices
	...
	vote: '보팅하기', // context: to vote? (title attribute on voting button)
	witness: '증인',
	top_witnesses: '증인 선출',
	...
	users_blog: "{name}'의 블로그",
	users_posts: "{name}'의 글",
	users_wallet: "{name}'의 지갑",
	users_curation_rewards: "{name}'의 큐레이션 보상",
	users_author_rewards: "{name}'의 저자 보상",
	users_permissions: "{name}'의 퍼미션",
	recent_replies_to_users_posts: "{name}'의 글에 대한 최근 답글",
	print: '프린트',
	...
	newer: '새로운',
	older: '오래된',
	author_rewards_last_24_hours: '지난 24시간의 저자 보상',
	daily_average_author_rewards: '일 평균 저자 보상',
	author_rewards_history: '저자 보상 내역',
	balance: '잔액',
	balances: '잔고',
	estimate_account_value: '예상 잔고 (미국 달러)',
	next_power_down_is_scheduled_to_happen_at: 'The next power down is scheduled to happen',
	transfers_are_temporary_disabled: '전송 일시 중지',
	history: '내역',
	// CurationRewards.jsx
	curation_rewards_last_24_hours: '지난 24시간의 큐레이션 보상',
	daily_average_curation_rewards: '일평균 큐레이션 보상',
	estimated_curation_rewards_last_week: "지난주 예상 큐레이션 보상",
	curation_rewards_last_week: "지난주 큐레이션 보상",
	...
	auto_login_question_mark: '자동 로그인 하시겠습니까?',
	yes: '예',
	no: '아니오',
	hide_private_key: '개인키 숨기기',
	show_private_key: '개인키 보이기',
	login_to_show: '로그인해서 확인하기',
	...
	public: '공개',
	private: '개인',
	public_something_key: '공개 {key} 키',
	private_something_key: '개인 {key} 키',
	...
	power_up: '파워 UP',
	power_down: '파워 Down',
	cancel_power_down: '파워 Down 취소하기',
	transfer: '전송',
	deposit: '예금',
	basic: '기본',
	advanced: '고급',
	...
	profile: '프로필',
	send_to_account: "받을 계정",
	confirm_email: '이메일 확인',
	authenticate_for_this_transaction: 'Authenticate for this transaction',
	login_to_your_APP_NAME_account: APP_NAME + ' 계정으로 로그인하기',
	// UserProfile > Permissions
	posting: '포스팅',
	owner: '마스터',
	active_or_owner: '액티브 또는 마스터',
	sign: '서명',
	dismiss: '숨기기',
	...
	reblogged_by: '리스팀한 사람들',
	reblog: "리스팀",
	updated: '수정됨',
	created: '생성됨',
	settings: '설정',
	incorrect_password: '일치하지 않는 패스워드입니다',
	username_does_not_exist: '존재하지 않는 계정입니다',
	// string with a '.'(dot) is returned from the server, so you should add it too, despite rules
	account_name_should_start_with_a_letter: '아이디는 문자로 시작해야합니다',
	account_name_should_be_shorter: '아이디가 너무 깁니다.',
	account_name_should_be_longer: '아이디가 너무 짧습니다.',
	account_name_should_have_only_letters_digits_or_dashes: '아이디는 문자나 숫자, 대시로만 이루어져야합니다.',
	choose_language: '언어를 선택해주세요',
	choose_currency: '기준통화를 선택해주세요',
	crowdsale: 'Crowdsale',
	followers: '팔로워',
	following: '팔로잉',
	// errors
