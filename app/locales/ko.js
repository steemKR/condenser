...
const ko = 	{
	...
	buy_LIQUID_TOKEN: LIQUID_TOKEN + ' 구매하기',
	sell_LIQUID_TOKEN: LIQUID_TOKEN + ' 판매하기',
	market: "Market",
	currency_market: "내부 마켓",
	stolen_account_recovery: "도난당한 계정 찾기",
	change_account_password: "계정 패스워드 변경",
	steemit_api_docs: "Steemit API Docs",
	APP_NAME_chat: APP_NAME + " 채팅",
	witnesses: "증인들",
	vote_for_witnesses: "증인들에게 보팅하기",
	...
	submit_a_story: '글 작성하기',
	nothing_yet: 'Nothing yet',
	close: 'Close',
	// next 5 strings were supposed to be sinngle block of text, but due large size,
	// code erros they were splitted.
	authors_get_paid_when_people_like_you_upvote_their_post: '작성자들은 당신과 다른 유저들이 작성자들의 글을 추천하면 보상을 받습니다.',
	if_you_enjoyed_what_you_read_earn_amount: '다른 유저들에게 답글을 달고 보상을 해주기 위해 커뮤니티에 가입하세요.',
	...
	submit_email_to_get_on_waiting_list: '대기열에 들어가기 위해 이메일 주소를 제출하세요.',
	login: '로그인',
	logout: '로그아웃',
	show_less_low_value_posts: "Show fewer low value posts",
	show_more_low_value_posts: "Show more low value posts",
	select_topic: '토픽을 선택하세요.',
	tags_and_topics: "인기있는 태그와 토픽",
	filter: "필터",
	...
	upvote_post: '글 추천하기',
	update_post: '글 수정하기',
	markdown_is_supported: '마크다운이 지원됩니다.',
	preview: '미리보기',
	markdown_not_supported: '현재 환경에서는 마크다운이 지원되지 않습니다.',
	welcome_to_the_blockchain: '블록체인의 세계로 오신 것을 환영합니다.',
	your_voice_is_worth_something: '당신의 목소리는 가치가 있습니다.',
	...
	tag_your_story: '태그 (최대 5개), 첫 번째 태그가 메인 카테고리로 설정됩니다.',
	...
	post: '작성하기', // places used: tooltip in MediumEditor
